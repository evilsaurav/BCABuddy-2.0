  ...
  return (
    ...
    >
      ...
      {hasRoadmap && safeDays.length > 0 ? (
        <>
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 12, marginBottom: 8 }}>
            <button
              ...
              style={{
                width: 30, height: 30, borderRadius: 999, border: '1px solid rgba(3,218,198,0.5)',
                background: 'rgba(3,218,198,0.12)', color: '#03dac6', cursor: 'pointer',
              }}
            >
              ‹
            </button>
            <button
              onClick={() => scrollBy(220)}
              style={{
                width: 30, height: 30, borderRadius: 999, border: '1px solid rgba(187,134,252,0.5)',
                background: 'rgba(187,134,252,0.12)', color: '#bb86fc', cursor: 'pointer',
              }}
            >
              ›
            </button>
        ...
        <div
          style={{
            marginTop: 14, padding: 12, borderRadius: 14, border: '1px solid rgba(255,255,255,0.12)',
            background: 'rgba(255,255,255,0.04)', color: 'rgba(255,255,255,0.72)', fontSize: 13, lineHeight: 1.6,
          }}
        >
